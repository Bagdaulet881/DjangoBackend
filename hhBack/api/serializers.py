...
from .models import Record, Status, User2
...
class RecordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Record
        # fields = '__all__'
        fields = ('id', 'created_at', 'phone',
                  'description', 'status_id', 'user_id')
class RecordInitialSerializer(serializers.ModelSerializer):

    status_id =serializers.PrimaryKeyRelatedField(many=False, read_only=True)
